...
exports.mapHeader = (element, type, gtmVersion, xmlNs, domain) => {
    return {
        name: element.name,
        required: true,
        disabled: renamer_1.getMandatoryElement(element.name, ITEM_MANDATORY_FIELD),
        display: renamer_1.getMandatoryElement(element.name, ITEM_MANDATORY_FIELD),
        isMandatory: renamer_1.getMandatoryElement(element.name, ITEM_MANDATORY_FIELD),
        type: type,
...
exports.mapItemFeature = (element, ItemFeature, type, gtmVersion, xmlNs, i, domain) => {
