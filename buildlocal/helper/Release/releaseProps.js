...
const RELEASE_MANDATORY_FIELD = [
    ...
    ...Object.values(other_2.NAME.release)
];
...
exports.mapHeader = (element, type, gtmVersion, xmlNs, domain) => {
    return {
        name: element.name,
        required: true,
        disabled: renamer_1.getMandatoryElement(element.name, RELEASE_MANDATORY_FIELD),
        display: renamer_1.getMandatoryElement(element.name, RELEASE_MANDATORY_FIELD),
        isMandatory: renamer_1.getMandatoryElement(element.name, RELEASE_MANDATORY_FIELD),
        type: type,
