...
exports.getItemPropfromGtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
...
exports.getReleasePropsfromGtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
...
exports.getLocationPropfromOtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
...
exports.getBomPropsfromGtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
...
exports.getTransactionPropsfromGtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
...
exports.getPartyPropfromGtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
...
exports.getOrderBasePropsfromGtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
...
exports.getTrackingEventPropfromOtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
...
exports.getShipmentPropsfromGtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
...
exports.getTransmissionStatus = (transmission, reProcess) => {
    return `<sql2xml>
    <Query>
      <RootName>
      TRANSACTION_STATUS
